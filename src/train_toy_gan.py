...
if __name__ == '__main__':
    ...
    parser.add_argument('--linearity_power', type=int, default=1)
    ...
    args.fig_save_path = '../results/toy_generation/figures/toy-%s-%s-lambda=%s-p%s%s.png' % (
        args.dataset_name, args.gan_name,
        'NA' if args.linearity_lambda == 0 else args.linearity_lambda, args.linearity_power,
